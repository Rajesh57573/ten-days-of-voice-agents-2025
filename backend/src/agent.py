...
# 👨‍⚕️ "Rajesh Store" - Auto-Lead Capture Agent
...
print("📚 SELLING: Rajesh's Cloud & AI Courses")
...
DEFAULT_FAQ = [
    ...
    },
    {
        ...
        "answer": "Yes! Rajesh releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Rajesh Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Rajesh and email you." (Don't hallucinate prices).
            """,
